...
🔊 Text-to-speech (TTS) for realistic HR interaction
⏱️ Timed interview session (5 minutes)
📊 Automatic performance review with rating
🎥 Live webcam interface for interview simulation
...
Browser APIs: Web Speech API (Speech Recognition), MediaDevices API
...
3. Questions are converted to voice using TTS
4. User answers via microphone (speech-to-text)
5. System stores conversation history
6. After interview, AI generates detailed feedback + rating
...
End-to-end interview simulation system
...
Backend integration for storing history
